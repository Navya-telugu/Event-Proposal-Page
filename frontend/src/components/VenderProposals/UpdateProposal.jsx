...
const navigate = useNavigate()
  ...
  useEffect(()=>{
    axios.get(`https://event-proposal-page-dp1n.onrender.com/update/${id}`).then(res=>{
    ...
    setPlaceOfEvent(data.placeOfEvent);
...
axios.put(`https://event-proposal-page-dp1n.onrender.com/update/${id}`,objsubmit)
